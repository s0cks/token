...
#define HTTP_CONTROLLER_ENDPOINT(Endpoint) \
  static void Handle##Endpoint(const ControllerPtr&, const SessionPtr&, const RequestPtr&); \
  virtual void On##Endpoint(const SessionPtr&, const RequestPtr& request);

#define HTTP_CONTROLLER_ROUTE_HANDLER(Controller, Name) \
  void Controller::Handle##Name(const ControllerPtr& instance, const SessionPtr& session, const RequestPtr& request){ \
...
#define HTTP_CONTROLLER_ENDPOINT_HANDLER(Controller, Name) \
  void Controller::On##Name(const SessionPtr& session, const RequestPtr& request)
